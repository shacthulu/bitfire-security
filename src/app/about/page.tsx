        ...
        <div className="flex flex-col max-w-full mx-auto py-8 pl-2 " role="main" >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col">
                    <h2 className="text-2xl font-semibold font-serif"><span className="text-red-600">Bitfire Security</span> partners with organizations to build resilient security programs that actually work. <br /><br /> We bring together cross-domain expertise to develop tailored solutions collaboratively. </h2>
                </div>
                <div className="space-y-4 mb-10 text-slate-700">
                    <p>
                        ...
                        We take a different approach. Bitfire works alongside your team to develop security solutions that fit your organization&apos;s specific context, risk profile, and operational reality. Our teams bring cross-domain mastery across governance, technical security, and risk management to deliver lasting solutions.<br /><br />
