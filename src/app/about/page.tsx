            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4 mb-10 text-slate-700">
                    <p>
                        ...
                        We take a different approach. Bitfire works alongside your team to develop security solutions that fit your organization&apos;s specific context, risk profile, and operational reality. Our teams bring cross-domain mastery across governance, technical security, and risk management to deliver lasting solutions.<br/>
